...
#NoTrayIcon
;@Ahk2Exe-ExeName deemator_0.3.0_installer.exe
;@Ahk2Exe-SetName deemator_0.3.0_installer
...
if not (A_IsAdmin) {
	...
	MsgBox "A_IsAdmin: " A_IsAdmin "`nCommand line: " DllCall("GetCommandLine", "str"), "deemator 0.3.0 installer"
	ExitApp
}

; INSTALLATION
if (MsgBox("Do you want to intall (reinstall) deemator 0.3.0 to this computer?", "deemator 0.3.0 installer", 4) = "Yes") {
	...
	if DirExist("C:\deemator") {
		try {
			...
			MsgBox("DirDelete`nerror", "deemator 0.3.0 installer error")
			ExitApp
		}
	}
	Sleep(installer_sleep_ms)
	try {
		...
		MsgBox("DirCreate`nerror", "deemator 0.3.0 installer error")
		ExitApp
	}
	Sleep(installer_sleep_ms)
	try {
		...
		MsgBox("FileInstall `"C:\deemator\third_party\deemator_tor.exe`", `"C:\deemator\third_party\deemator_tor.exe`", 1", "deemator 0.3.0 installer error")
		ExitApp
	}
	Sleep(installer_sleep_ms)
	try {
		...
		MsgBox("FileInstall `"C:\deemator\third_party\geoip`", `"C:\deemator\third_party\geoip`", 1", "deemator 0.3.0 installer error")
		ExitApp
	}
	Sleep(installer_sleep_ms)
	try {
		...
		MsgBox("FileInstall `"C:\deemator\third_party\geoip6`", `"C:\deemator\third_party\geoip6`", 1", "deemator 0.3.0 installer error")
		ExitApp
	}
	Sleep(installer_sleep_ms)
	try {
		...
		MsgBox("FileInstall `"C:\deemator\third_party\lyrebird.exe`", `"C:\deemator\third_party\lyrebird.exe`", 1", "deemator 0.3.0 installer error")
		ExitApp
	}
	Sleep(installer_sleep_ms)
	try {
		...
		MsgBox("FileInstall `"C:\deemator\deemator.lnk`",A_Desktop . `"\deemator.lnk`", 1", "deemator 0.3.0 installer error")
		ExitApp
	}
	Sleep(installer_sleep_ms)
	try {
		...
		MsgBox("FileInstall `"C:\deemator\deemator.lnk`", `"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\deemator.lnk`", 1", "deemator 0.3.0 installer error")
		ExitApp
	}
	Sleep(installer_sleep_ms)
	try {
		...
		MsgBox("FileInstall `"C:\deemator\icon.ico`", `"C:\deemator\icon.ico`", 1", "deemator 0.3.0 installer error")
		ExitApp
	}
	Sleep(installer_sleep_ms)
	try {
		...
		MsgBox("FileInstall `"C:\deemator\LICENSE`", `"C:\deemator\LICENSE`", 1", "deemator 0.3.0 installer error")
		ExitApp
	}
	Sleep(installer_sleep_ms)
	try {
		...
		MsgBox("FileInstall `"C:\deemator\main.exe`", `"C:\deemator\main.exe`", 1", "deemator 0.3.0 installer error")
		ExitApp
	}
	Sleep(installer_sleep_ms)
	try {
		...
		MsgBox("FileInstall `"C:\deemator\torrc`", `"C:\deemator\torrc`", 1", "deemator 0.3.0 installer error")
		ExitApp
	}
	Sleep(installer_sleep_ms)
	try {
		...
		MsgBox("C:\deemator\img", "deemator 0.3.0 installer error")
		ExitApp
	}
	Sleep(installer_sleep_ms)
	MsgBox("Successfully installed deemator 0.3.0 to this computer.`nA startup link was placed at the desktop.", "deemator 0.3.0 installer")
	Sleep(installer_sleep_ms)
	ExitApp
} else {
	ExitApp
